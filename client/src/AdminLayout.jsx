    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      `}>
        ...
        <div className="px-3 py-4 border-t border-navy-700 space-y-1">
          <Link to="/" className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-400 hover:bg-navy-800 hover:text-white font-sans text-sm transition-colors">
            <span>🌐</span> View Site
          </Link>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100 shadow-sm flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            <Link to="/dashboard" className="font-sans text-sm text-gray-500 hover:text-navy-700 transition-colors hidden sm:block">
              Customer View
            </Link>
